...
const Index = () => {
  const [photos, setPhotos] = useState([
    ...
    { id: 8, url: 'https://cdn.poehali.dev/files/10c786e8-5d15-4c4c-acf4-7a0dfb4835a1.jpg', description: 'Ты и твой парень Даня в кино смотрите Супермена, тогда ты немного плакала' },
    { id: 9, url: 'https://cdn.poehali.dev/files/9a5411e0-cf6f-4abe-b052-98f4c3ee2cac.jpg', description: 'Мы с тобой в корпусе, очень вайбовая фотка, как с обложки альбома' }
  ]);
...
(твою любовь к томатному я не пойму никогда)</p>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 bg-gradient-to-r from-yellow-500 to-pink-500 bg-clip-text text-transparent font-montserrat">Песни, с которыми ты ассоциируешься </h2>
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
              <CardContent className="p-8">
                <div className="space-y-4">
                  {playlist.map((song, index) => (
                    <div key={index} className="flex items-center justify-between p-4 rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 transition-all duration-300">
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-yellow-100 to-pink-100">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <p className="text-3xl font-bold text-pink-600">Дорогая, с днём рождения! 🎂
Будь счастлива всегда! Ты заслуживаешь всего самого лучшего. Люблю и крепко-крепко обнимаю! 💖</p>
            </div>
          </div>
        </section>
